...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'githubUrl' => 'GitHub',
        'portfolioUrl' => 'site/portfólio',
        'professionalSummary' => 'resumo profissional',

        // Experiência
        'newCompany' => 'empresa',
        'newPosition' => 'cargo',
        'newStartDate' => 'data inicial',
        'newEndDate' => 'data final',
        'newDescription' => 'descrição',

        // Formação
        'newInstitution' => 'instituição',
        'newCourse' => 'curso',
        'newDegree' => 'grau',
        'newEduStartDate' => 'data inicial',
        'newEduEndDate' => 'data final',

        // Cursos
        'newCourseName' => 'nome do curso',
        'newCourseInstitution' => 'instituição',

        // Habilidades e idiomas
        'newSkillName' => 'habilidade',
        'newLanguageName' => 'idioma',
        'newLanguageLevel' => 'nível',

        // Vaga / carta de apresentação
