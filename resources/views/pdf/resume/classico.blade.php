...
<head>
    ...
    <style>
        ...
        .cv-section-title { font-size: 11px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; color: #1E3A5F; border-bottom: 1.5px solid {{ $accentColor }}; padding-bottom: 3px; margin: 0 0 7px; }
